...
privileged aspect PetController_Roo_GvNIXLoupeController {
    ...
    public ResponseEntity<List<Map<String, String>>> PetController.findUsingAjax(WebRequest request, @RequestParam(value = "_search_", required = false) String search, @RequestParam(value = "_id_", required = false) String id, @RequestParam("_pkField_") String pkField, @RequestParam(value = "_max_", required = false, defaultValue = "3") Integer maxResult, @RequestParam(value = "_caption_", required = false) String caption, @RequestParam(value = "_additionalFields_", required = false) String additionalFields, @RequestParam("_field_") String field) {
        ...
        // Getting Entity
        BeanWrapper petBean = new BeanWrapperImpl(Pet.class);
        // Getting field
        Class targetEntity = petBean.getPropertyType(field);
