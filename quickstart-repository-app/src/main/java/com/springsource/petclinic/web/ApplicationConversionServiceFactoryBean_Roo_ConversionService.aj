...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    @Autowired
    OwnerService ApplicationConversionServiceFactoryBean.ownerService;
    
    @Autowired
    PetService ApplicationConversionServiceFactoryBean.petService;
    
    @Autowired
    VetService ApplicationConversionServiceFactoryBean.vetService;
    
    @Autowired
    VisitService ApplicationConversionServiceFactoryBean.visitService;
