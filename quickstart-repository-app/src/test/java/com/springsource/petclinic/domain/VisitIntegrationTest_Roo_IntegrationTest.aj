...
privileged aspect VisitIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    VisitService VisitIntegrationTest.visitService;
    
    @Autowired
    VisitRepository VisitIntegrationTest.visitRepository;
    
    @Test
    public void VisitIntegrationTest.testCountAllVisits() {
        Assert.assertNotNull("Data on demand for 'Visit' failed to initialize correctly", dod.getRandomVisit());
        long count = visitService.countAllVisits();
    ...
    public void VisitIntegrationTest.testFindAllVisits() {
        ...
        List<Visit> result = visitService.findAllVisits();
    ...
    public void VisitIntegrationTest.testFindVisitEntries() {
        ...
        List<Visit> result = visitService.findVisitEntries(firstResult, maxResults);
    ...
    @Test
    public void VisitIntegrationTest.testUpdateVisitUpdate() {
        Visit obj = dod.getRandomVisit();
        Assert.assertNotNull("Data on demand for 'Visit' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Visit' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifyVisit(obj);
        Integer currentVersion = obj.getVersion();
        Visit merged = visitService.updateVisit(obj);
        visitRepository.flush();
    ...
    @Test
    public void VisitIntegrationTest.testSaveVisit() {
        Assert.assertNotNull("Data on demand for 'Visit' failed to initialize correctly", dod.getRandomVisit());
    ...
    @Test
    public void VisitIntegrationTest.testDeleteVisit() {
        Visit obj = dod.getRandomVisit();
        Assert.assertNotNull("Data on demand for 'Visit' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Visit' failed to provide an identifier", id);
        obj = visitService.findVisit(id);
        visitService.deleteVisit(obj);
        visitRepository.flush();
        Assert.assertNull("Failed to remove 'Visit' with identifier '" + id + "'", visitService.findVisit(id));
    }
