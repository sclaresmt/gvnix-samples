...
privileged aspect VetIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    VetService VetIntegrationTest.vetService;
    
    @Autowired
    VetRepository VetIntegrationTest.vetRepository;
    
    @Test
    public void VetIntegrationTest.testCountAllVets() {
        Assert.assertNotNull("Data on demand for 'Vet' failed to initialize correctly", dod.getRandomVet());
        long count = vetService.countAllVets();
    ...
    public void VetIntegrationTest.testFindVetEntries() {
        ...
        List<Vet> result = vetService.findVetEntries(firstResult, maxResults);
    ...
    @Test
    public void VetIntegrationTest.testUpdateVetUpdate() {
        Vet obj = dod.getRandomVet();
        Assert.assertNotNull("Data on demand for 'Vet' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Vet' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifyVet(obj);
        Integer currentVersion = obj.getVersion();
        Vet merged = (Vet)vetService.updateVet(obj);
        vetRepository.flush();
    ...
    @Test
    public void VetIntegrationTest.testSaveVet() {
        Assert.assertNotNull("Data on demand for 'Vet' failed to initialize correctly", dod.getRandomVet());
    ...
    @Test
    public void VetIntegrationTest.testDeleteVet() {
        Vet obj = dod.getRandomVet();
        Assert.assertNotNull("Data on demand for 'Vet' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Vet' failed to provide an identifier", id);
        obj = vetService.findVet(id);
        vetService.deleteVet(obj);
        vetRepository.flush();
        Assert.assertNull("Failed to remove 'Vet' with identifier '" + id + "'", vetService.findVet(id));
    }
