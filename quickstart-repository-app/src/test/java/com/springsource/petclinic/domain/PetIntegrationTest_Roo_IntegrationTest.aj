...
privileged aspect PetIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    PetService PetIntegrationTest.petService;
    
    @Autowired
    PetRepository PetIntegrationTest.petRepository;
    
    @Test
    public void PetIntegrationTest.testCountAllPets() {
    ...
    public void PetIntegrationTest.testFindPetEntries() {
        ...
        List<Pet> result = petService.findPetEntries(firstResult, maxResults);
    ...
    @Test
    public void PetIntegrationTest.testUpdatePetUpdate() {
        Pet obj = dod.getRandomPet();
        Assert.assertNotNull("Data on demand for 'Pet' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Pet' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifyPet(obj);
        Integer currentVersion = obj.getVersion();
        Pet merged = petService.updatePet(obj);
        petRepository.flush();
    ...
    @Test
    public void PetIntegrationTest.testSavePet() {
        Assert.assertNotNull("Data on demand for 'Pet' failed to initialize correctly", dod.getRandomPet());
    ...
    @Test
    public void PetIntegrationTest.testDeletePet() {
        Pet obj = dod.getRandomPet();
        Assert.assertNotNull("Data on demand for 'Pet' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Pet' failed to provide an identifier", id);
        obj = petService.findPet(id);
        petService.deletePet(obj);
        petRepository.flush();
        Assert.assertNull("Failed to remove 'Pet' with identifier '" + id + "'", petService.findPet(id));
    }
