...
privileged aspect OwnerIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    OwnerService OwnerIntegrationTest.ownerService;
    
    @Autowired
    OwnerRepository OwnerIntegrationTest.ownerRepository;
    
    @Test
    public void OwnerIntegrationTest.testCountAllOwners() {
        Assert.assertNotNull("Data on demand for 'Owner' failed to initialize correctly", dod.getRandomOwner());
        long count = ownerService.countAllOwners();
    ...
    public void OwnerIntegrationTest.testFindAllOwners() {
        ...
        List<Owner> result = ownerService.findAllOwners();
    ...
    public void OwnerIntegrationTest.testFindOwnerEntries() {
        ...
        List<Owner> result = ownerService.findOwnerEntries(firstResult, maxResults);
    ...
    @Test
    public void OwnerIntegrationTest.testUpdateOwnerUpdate() {
        Owner obj = dod.getRandomOwner();
        Assert.assertNotNull("Data on demand for 'Owner' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Owner' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifyOwner(obj);
        Integer currentVersion = obj.getVersion();
        Owner merged = (Owner)ownerService.updateOwner(obj);
        ownerRepository.flush();
    ...
    @Test
    public void OwnerIntegrationTest.testSaveOwner() {
        Assert.assertNotNull("Data on demand for 'Owner' failed to initialize correctly", dod.getRandomOwner());
    ...
    @Test
    public void OwnerIntegrationTest.testDeleteOwner() {
        Owner obj = dod.getRandomOwner();
        Assert.assertNotNull("Data on demand for 'Owner' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Owner' failed to provide an identifier", id);
        obj = ownerService.findOwner(id);
        ownerService.deleteOwner(obj);
        ownerRepository.flush();
        Assert.assertNull("Failed to remove 'Owner' with identifier '" + id + "'", ownerService.findOwner(id));
    }
