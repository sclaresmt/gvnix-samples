...
:quickstart: https://github.com/DISID/gvnix-samples/tree/master/quickstart-app
...
If you don't know _What is gvNIX?_ you should start with {basic gvNIX application}[quickstart] tutorial.
...
purpose, we will build an application based on {quickstart-app}[quickstart] tutorial.
