...
image:images/CRU_map.png[width="70%", align="center"]
...
image:images/menu.png[width="25%", align="center"]
image:images/simple_map.png[width="70%", align="center"]
...
gvNIX provides you the possibility to display entity data on map views. 
...
image:images/map_entities.png[width="70%", align="center"]
image:images/map_entity_0.png[width="70%",align="center"]
image:images/map_entities_1.png[width="70%", align="center"]
