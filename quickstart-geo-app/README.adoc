...
. If you filter Datatable, you are going to show only filtered records.
image:images/filter_1.png[width="100%"]

. If you filter Datatable with other value, you are going to show different filtered records.
