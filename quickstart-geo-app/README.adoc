...
. <<spatial-support, Add Spatial Support>>
. <<geo-fields, Add Geo Entity Fields>>
. <<geo-finders, Generate Geo Entity Finders>>
. <<map-views, Generate Map Views>>
...
When you have a valid POSTGIS Database configured on your system, you can execute the following command:
+
