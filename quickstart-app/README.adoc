...
image:images/sample-application-login.png[scaledwidth="35%"]
image:images/sample-application-home.png[scaledwidth="35%"]
image:images/sample-application-pet-creation.png[scaledwidth="35%"]
