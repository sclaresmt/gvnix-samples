...
image:images/sample-application-login.png[width="50%"]
image:images/sample-application-home.png[width="50%"]
image:images/sample-application-pet-creation.png[width="50%"]
