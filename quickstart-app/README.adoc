...
image:images/sample-application-login.png[width="35%"]
image:images/sample-application-home.png[width="35%"]
image:images/sample-application-pet-creation.png[width="35%"]
