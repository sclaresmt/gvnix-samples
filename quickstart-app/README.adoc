...
web mvc datatables add --type ~.web.VisitController --inlineEditing true

[icon="images/icons/note.png"]
NOTE: _Use *--mode* param with show value, to display only a record per page_ <br/> _Use *--inlineEditing* param with true value to enable inline creation and inline update_
...
image:images/sample-application-login.png["Login", align="left", scaledwidth="35%"]
image:images/sample-application-home.png["Login", align="center", scaledwidth="35%"]
image:images/sample-application-pet-creation.png["Login", align="right", scaledwidth="35%"]
