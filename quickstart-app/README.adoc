...
NOTE: _Replace *provider* param and *database* param with your own configuration. Use this to follow the guide._
...
. _*(Optional)*_ If you want to install some *differents languages* to use in your application, execute de following commands:
+
