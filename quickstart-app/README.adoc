...
. <<jquery-setup, JQuery, Datatables and Bootstrap Setup >>
...
[icon="images/icons/note.png"]
NOTE: _You need to execute *web mvc bootstrap update* after security setup to displays login as Bootstrap appearance._
